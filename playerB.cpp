...
void output_command() //请不要删除End一行，每行输出记得加上换行符
{
    ...
    if (frame_count < 1000)
    {
        cout << "move gunner 35 23.5" << endl;
    }else if (frame_count < 2000)
    {
        cout << "move gunner 25 23.5" << endl;
    }else
    {
        cout << "shoot gunner " << GunnerB_Pos.first - 1 << " " << GunnerB_Pos.second << endl;
    }
    cout << "skill hurler 1 30 30" << endl;
    cout << "skill hurler 2" << endl;
    cout << "skill gunner 1" << endl;
    cout << "skill gunner 2" << endl;
    cout << "skill medic 1 38.5 38.5" << endl;
